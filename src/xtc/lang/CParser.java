...
// on Tuesday, September 9, 2025 at 7:35:37 PM.
 ...
 */
public final class CParser extends ParserBase {
  ...
  static final class CParserColumn extends Column {
    Chunk1 chunk1;
    Chunk2 chunk2;
    Chunk3 chunk3;
    Chunk4 chunk4;
   ...
   */
  public CParser(final Reader reader, final String file) {
    super(reader, file);
   ...
   */
  public CParser(final Reader reader, final String file, final int size) {
  ...
  private Result pDeclarationSpecifiers(final int yyStart) 
    ...
    CParserColumn yyColumn = (CParserColumn)column(yyStart);
