...
// on Tuesday, September 9, 2025 at 7:35:35 PM.
 ...
 */
public final class JavaSevenParser extends ParserBase {
  ...
  static final class JavaSevenParserColumn extends Column {
    Chunk1 chunk1;
    Chunk2 chunk2;
    Chunk3 chunk3;
    Chunk4 chunk4;
   ...
   */
  public JavaSevenParser(final Reader reader, final String file) {
    super(reader, file);
  }
   ...
   */
  public JavaSevenParser(final Reader reader, final String file, final int size) {
  ...
  protected Column newColumn() {
    return new JavaSevenParserColumn();
  }
  ...
  private Result pModifiers(final int yyStart) throws IOException {
    JavaSevenParserColumn yyColumn = (JavaSevenParserColumn)column(yyStart);
  ...
  /**
   * Parse synthetic nonterminal xtc.lang.JavaSeven.FormalParameters$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse xtc.lang.JavaSeven.FormalParameters$$Star1. */
  ...
  /**
   * Parse synthetic nonterminal xtc.lang.JavaSeven.Block$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse xtc.lang.JavaSeven.Block$$Star1. */
  ...
  private Result pPostfixExpression$$Tail1(final int yyStart) 
    ...
    if (yyResult.hasValue(".")) {
      ...
      yyError  = yyResult.select(yyError);
      if (yyResult.hasValue()) {
        final String v$g$8 = yyResult.semanticValue();
  ...
  private Result pResource(final int yyStart) throws IOException {
    ...
    if (null == yyColumn.chunk3.fResource) 
      yyColumn.chunk3.fResource = pResource$1(yyStart);
    return yyColumn.chunk3.fResource;
  }
  ...
  /**
   * Parse synthetic nonterminal xtc.lang.JavaSeven.TypeParameters$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse xtc.lang.JavaSeven.TypeParameters$$Star1. */
  ...
  /**
   * Parse synthetic nonterminal xtc.lang.JavaSeven.TypeArguments$$Star1.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
  ...
  /** Actually parse xtc.lang.JavaSeven.TypeArguments$$Star1. */
